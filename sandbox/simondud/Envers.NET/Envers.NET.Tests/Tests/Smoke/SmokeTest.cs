...
namespace NHibernate.Envers.Tests.Smoke
{
    ...
    public class SmokeTest
    {
        ...
        public void TestSessionFactory()
        {
            ...
            personRepository.Remove(persoana);
            ...
            foreach (object personRevId in personRevisionIds)
            {
                ...
                System.Console.Write("Id-ul de revizie:" + personRevId + ":" + auditedPerson.firstName + " " + auditedPerson.lastName + " -> " + auditedPerson.cont.IBAN);
            }
