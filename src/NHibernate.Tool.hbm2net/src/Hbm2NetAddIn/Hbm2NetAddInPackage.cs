...
namespace FelicePollano.Hbm2NetAddIn
{
    ...
    [Guid(GuidList.guidHbm2NetAddInPkgString)]
    [ProvideAutoLoad(UIContextGuids.NoSolution)]
    public sealed class Hbm2NetAddInPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public Hbm2NetAddInPackage()
        {
            
        }

        void rdtManager_SavedProjectItem(object sender, SavedProjectItemEventArgs e)
        {
            if (Path.GetExtension(e.SavedPath).Equals(".xml", StringComparison.OrdinalIgnoreCase))
            {
