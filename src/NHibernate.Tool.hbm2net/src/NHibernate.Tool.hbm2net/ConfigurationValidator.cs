...
namespace NHibernate.Tool.hbm2net
{
    public class ConfigurationValidator
    {
        ...
        {
            XmlSchema schema = XmlSchema.Read(Assembly.GetExecutingAssembly().GetManifestResourceStream("NHibernate.Tool.hbm2net.nhibernate-tool-hbm2net-configuration.xsd"),null);
