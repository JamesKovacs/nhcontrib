...
namespace NHibernate.NHDesigner
{
	...
	/// </remarks>
	public partial class NHDesignerHelpKeywordHelper : NHDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NHDesignerHelpKeywordHelper.
		/// </summary>
		protected NHDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NHDesignerHelpKeywordHelper.
		/// </summary>
		public static NHDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NHDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NHDesignerHelpKeywordHelperBase.
		/// </summary>
		protected NHDesignerHelpKeywordHelperBase()
			: base() { }
