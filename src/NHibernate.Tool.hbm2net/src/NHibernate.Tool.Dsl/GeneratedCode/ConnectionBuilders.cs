...
namespace NHibernate.NHDesigner
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class EntityReferencesIdentifiersBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::NHibernate.NHDesigner.Identifier)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::NHibernate.NHDesigner.Entity)
				{
					if (candidateTarget is global::NHibernate.NHDesigner.Identifier)
					{
						global::NHibernate.NHDesigner.Entity sourceEntity = (global::NHibernate.NHDesigner.Entity)candidateSource;
						global::NHibernate.NHDesigner.Identifier targetIdentifier = (global::NHibernate.NHDesigner.Identifier)candidateTarget;
						if(targetIdentifier == null || global::NHibernate.NHDesigner.EntityReferencesIdentifiers.GetLinkToEntity(targetIdentifier) != null) return false;
						if(targetIdentifier == null || sourceEntity == null || global::NHibernate.NHDesigner.EntityReferencesIdentifiers.GetLinks(sourceEntity, targetIdentifier).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::NHibernate.NHDesigner.Entity)
				{
					if (target is global::NHibernate.NHDesigner.Identifier)
					{
						global::NHibernate.NHDesigner.Entity sourceAccepted = (global::NHibernate.NHDesigner.Entity)source;
						global::NHibernate.NHDesigner.Identifier targetAccepted = (global::NHibernate.NHDesigner.Identifier)target;
						DslModeling::ElementLink result = new global::NHibernate.NHDesigner.EntityReferencesIdentifiers(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class IDConnectorConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new IDConnectorConnectAction for the given Diagram.
		/// </summary>
		public IDConnectorConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the IDConnectorConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new IDConnectorConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class IDConnectorConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the IDConnectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected IDConnectorConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder EntityReferencesIdentifiersBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				if(sourceShapeElement == null) throw new global::System.ArgumentNullException("sourceShapeElement");
				...
				if(targetShapeElement == null)
				{
					return EntityReferencesIdentifiersBuilder.CanAcceptSource(sourceElement);
				}
				else
				{
					targetShapeElement = RemovePassThroughShapes(targetShapeElement);
					...
					return EntityReferencesIdentifiersBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
				}
			}
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				EntityReferencesIdentifiersBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class IDConnectorConnectionType : IDConnectorConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the IDConnectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			public IDConnectorConnectionType() : base() {}
		}
	}
}
