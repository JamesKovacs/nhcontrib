...
namespace NHibernate.NHDesigner
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.NHDesignerEditorFactoryId)]
	internal partial class NHDesignerEditorFactory : NHDesignerEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new NHDesignerEditorFactory.
		/// </summary>
		public NHDesignerEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class NHDesignerEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected NHDesignerEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new NHDesignerDocData(this.ServiceProvider, typeof(NHDesignerEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new NHDesignerDocView(docData, this.ServiceProvider);
		}
	}
}
