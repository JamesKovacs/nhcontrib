...
namespace NHibernate.NHDesigner
{
	...
	/// </summary>
	internal partial class NHDesignerExplorer : NHDesignerExplorerBase
	{
		/// <summary>
		/// Constructs a new NHDesignerExplorer.
		/// </summary>
		public NHDesignerExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the NHDesignerExplorerToolWindow.
	/// </summary>
	internal abstract class NHDesignerExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new NHDesignerExplorerBase.
		/// </summary>
		protected NHDesignerExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.NHDesignerExplorerMenu;
			}
		}
		...
		{
			get { return global::NHibernate.NHDesigner.NHibernateModel.DomainClassId; }
		}
