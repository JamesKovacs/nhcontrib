...
namespace NHibernate.Burrow.Test.AuditLogTest {
    [TestFixture]
    public class AuditLogTest : NHTestBase {
        [Test]
        public void AuditTest() {
            ...
            BooDomainLayer.Current.UserId = mockUserId;
            ...
            foreach (AuditLogRecord record in result) {
                Console.WriteLine( record.Action + " " + record.EntityId + " " + record.PropertyName + " " + record.NewValue);
