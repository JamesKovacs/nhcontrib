...
namespace NHibernate.Burrow.NHDomain.AuditLog {
    ...
    public class AuditLogRecord {
        ...
        internal static AuditLogRecord Create() {
            ...
            if (Configuration.IsUsingDomainLayer
                && DLContainer.DomainSession != null
                && DLContainer.DomainSession is IHasUserId)
                retVal.UserId = ((IHasUserId)DLContainer.DomainSession).UserId + string.Empty;
