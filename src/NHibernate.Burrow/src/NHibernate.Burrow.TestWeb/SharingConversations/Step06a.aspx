<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Step06a.aspx.cs" Inherits="SharingConversations_Step07" %>
...
<body onload="checkCerrar()">
    ...
    <div>
        ...
        <p>We have successful checked that new conversation is create with target="_blank" after use SpanWithHttpSession</p>
