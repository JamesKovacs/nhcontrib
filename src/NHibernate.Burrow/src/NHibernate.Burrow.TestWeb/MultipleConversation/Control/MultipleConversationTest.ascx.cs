...
public partial class MultipleConversation_Control_MultipleConversationTest : System.Web.UI.UserControl
{
    ...
    private int currentStepProgress
    {
        get
        {
            return   Session["MultipleConversationStep" + currentStep] is int ? (int) Session["MultipleConversationStep" + currentStep] : 0;
        }
