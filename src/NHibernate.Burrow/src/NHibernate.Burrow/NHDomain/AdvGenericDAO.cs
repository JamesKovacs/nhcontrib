...
namespace NHibernate.Burrow.NHDomain {
    ...
    /// <typeparam name="NHT">Type with which the DAO uses to query with NHibernate</typeparam>
    public class AdvGenericDAO<ReturnT, NHT> : IGenericDAO<ReturnT> {
        /// <summary>
        ...
        /// 
        /// </summary>
        /// <param name="a">the Domain Assembly of the entity this DAO is about</param>
        public AdvGenericDAO(Assembly a) {
            this.a = a;
        }

        public AdvGenericDAO() : this(typeof (NHT).Assembly) {}

        private SessionManager sm {
            get {
                if (_sm == null)
                    _sm = PersistantUnitRepo.Instance.GetPUOfDomainAssembly(a).SessionManager;
                return _sm;
            }
        }
        ...
        #region IGenericDAO<ReturnT> Members
        ...
        public ReturnT FindById(object id) {
            return (ReturnT) Sess.Get(typeof (NHT), id);
        }
        ...
        protected IQuery CreateQuery(string queryString) {
            ...
            string pre = completeQuery ? "" : "from " + typeof (NHT).Name + " ";
        ...
        public ReturnT Load(object id) {
            ReturnT retval = (ReturnT) Sess.Load(typeof (NHT), id);
            OnLoad(retval);
            return retval;
        }
        ...
        protected ICriteria GetCriteria() {
            ICriteria retVal = Sess.CreateCriteria(typeof (NHT));
            if (DefaultCacheable)
                retVal.SetCacheable(DefaultCacheable).SetCacheRegion(DefaultCacheRegion);
            return retVal;
        }
        ...
        protected ICriteria GetCriteria(string alias) {
            return Sess.CreateCriteria(typeof (NHT), alias);
        }
        ...
        /// <param name="startRow"></param>
        /// <returns></returns>
        /// <remarks>Obsolete. Probabably should be a private method</remarks>
        protected static IList<ReturnT> PagedCriteria(ICriteria c, int pageSize, int startRow) {
