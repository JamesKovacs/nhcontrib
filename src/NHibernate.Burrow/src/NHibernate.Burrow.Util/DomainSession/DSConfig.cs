...
namespace NHibernate.Burrow.Util.DomainSession
{
    public class DSConfig
    {
        ...
        {
            get { return !string.IsNullOrEmpty(CurrentDomainSessionFactoryName()); }
        }
        ...
        public static IDomainSessionFactory GetDomainSessionFactory()
        {
            ...
            {
                throw new Exception("To use auto managed domainSession the \"domainSessionFactory\" must be set in the "
