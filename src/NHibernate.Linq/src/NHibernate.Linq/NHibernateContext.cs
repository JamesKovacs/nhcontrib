...
namespace NHibernate.Linq
{
  ...
  /// </summary>
    ...
    /// <param name="fullTypeName">Full name of the type.</param>
    /// <returns></returns>
    object IUpdatable.ReplaceResource(System.Linq.IQueryable query, string fullTypeName)
    {
      IUpdatable update = (IUpdatable)this;

      // Get the original resource
      object resource = ((IUpdatable)this).GetResource(query, fullTypeName);
