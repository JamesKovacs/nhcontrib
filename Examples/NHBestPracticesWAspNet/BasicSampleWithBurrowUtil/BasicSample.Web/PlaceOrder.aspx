    ...
    <form id="form1" runat="server">
        <div>
         <a href="Default.aspx">return to the homepage</a>.<br />
           <asp:HyperLink ID="hlOrders" Target="_blank" NavigateUrl="~/recentorders.aspx" runat="server">Show recent orders</asp:HyperLink><br />
            <asp:Label ID="lMessage" runat="server" Text="" ForeColor="red" ></asp:Label>
            <br /><br /><br />         
            ...
            <asp:PlaceHolder ID="phEnterShipToName" runat="server" Visible="false">Please enter
                ...
                <asp:Button ID="btnEnterShipTo" runat="server" Text="Next" OnClick="btnEnterShipTo_Click" />   
            ...
            <asp:PlaceHolder ID="phConfirm" runat="server" Visible="false">Customer:
                ...
                <asp:Button ID="btnConfirm" runat="server" Text="Confirm" OnClick="btnConfirm_Click" />    
                 <asp:Button ID="btnCancel2" OnClick="btnCancel_Click" runat="server" Text="cancel"></asp:Button>
            </asp:PlaceHolder>
            <br /><br /><br />
