    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtCompanyName"
                runat="server" ErrorMessage="Company name must be provided" />
        </td>
    </tr>
    <tr>
        <td>
...
<ww:wwDataBinder ID="DataBinder" runat="server" DefaultBindingSource="customer">
    <DataBindingItems>
        <ww:wwDataBindingItem ID="dbiName" runat="server" BindingMode="oneway" ControlId="lblCustomerID"
            BindingProperty="Text" BindingSourceMember="ID" />
        <ww:wwDataBindingItem ID="dbiCompanyName" runat="server" ControlId="txtCompanyName"
            BindingProperty="Text" BindingSourceMember="CompanyName" />
        <ww:wwDataBindingItem ID="WwDataBindingItem1" runat="server" ControlId="txtContactName"
            BindingProperty="Text" BindingSourceMember="ContactName" />
    </DataBindingItems>
</ww:wwDataBinder>
<hr />
<h2>
